...
- **Find hidden potions** tucked behind stumps, rocks, and coral formations. Collecting one fully heals Little Fox and temporarily doubles his size for 10 seconds
- **Pick up ammo crates** (glowing star boxes) on Medium and Hard to reload your pellets
- **Watch for boss telegraphs** — color shifts and shadows warn you an attack is coming
...
| Character | Role |
|---|---|
| **Little Fox** | Player-controlled hero. Fast, agile, fires pellets on click |
...
**Boss:** The Forest Guardian — a massive spider/root creature that charges and drops webs. Defeat it to free Baby Bear.

### Level 2 — The Desert
Sandy dunes, sandstone ruins, and crumbling bridges. Baby Bear fights alongside you here.

**Boss:** The Scorpion King — claw swipes and a tail sting arc. On Hard, it throws sand to cloud your view. Defeat it to free Steggie.

### Level 3 — The Ocean
Coastal cliffs, coral reefs, and a sunken wreck. Both Baby Bear and Steggie join the fight.

**Boss:** The Kraken — tentacle slams, ink spray, and a roar that pushes everyone back. The most intense battle in the game. Win to rescue Mama Sloth.
...
| Boss telegraph window | 1.5s | 1.0s | 0.6s |
